        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [                    
                    ...
                    InlineKeyboardButton("• Cʜᴀᴛᴢᴏɴᴇ", url=f"https://t.me/maitri_chi_duniya"),
                    InlineKeyboardButton(" Cʜᴀᴛᴢᴏɴᴇ •", url=f"https://t.me/maitri_chi_duniya")
               ],[
                    InlineKeyboardButton("📨 Sᴜᴘᴘᴏʀᴛ", url=f"https://t.me/maitri_chi_duniya"),
                    InlineKeyboardButton(" Uᴘᴅᴀᴛᴇs 📨", url=f"https://t.me/king_x_network")
                ],[
